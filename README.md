[![Build Status](https://travis-ci.org/Hojlb/js-assignments.svg?branch=master)](https://travis-ci.org/Hojlb/js-assignments)
![Hackage-Deps](https://img.shields.io/hackage-deps/v/lens.svg)
[![Greenkeeper badge](https://badges.greenkeeper.io/Hojlb/js-assignments.svg)](https://greenkeeper.io/)
[![GitHub release](https://img.shields.io/github/release/Hojlb/js-assignments.svg)](https://github.com/Hojlb/js-assignments/releases/latest)
...
* Edit local README.md file and update all links (just replace all occurrences of `'Hojlb'` with your account name).
...
```
* Open https://github.com/Hojlb/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/Hojlb/js-assignments/builds).
